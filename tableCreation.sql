...
CREATE TABLE MeasureDefinition (
	...
	measureName VARCHAR(40) NOT NULL,
	measureType VARCHAR(40) NOT NULL,
	startValue VARCHAR(40) DEFAULT 'NULL',
	endValue VARCHAR(40) DEFAULT 'NULL',
	alarmLevel VARCHAR(40) DEFAULT 'NULL'
	)
...
VALUES ('1','1','70','weight','2015-02-10','2016-01-15','0'),
 ...
 ('2','2','3','water', '2014-10-29','2014-12-01','1'),
